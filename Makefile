...
build-in-badger-win:
	CGO_ENABLED=0 GOOS=windows GOARCH=amd64  go build  -a -installsuffix nocgo -tags driver_badger,${EXT_BUILD_TAGS} -mod=vendor -a -ldflags '-X github.com/loggie-io/loggie/pkg/core/global._VERSION_=${TAG} -X github.com/loggie-io/loggie/pkg/util/persistence._DRIVER_=badger -s -w' -o loggie.exe cmd/loggie/main.go
